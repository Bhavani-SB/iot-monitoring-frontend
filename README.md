...
- `tailwind.config.js`: Configuration for styling and utility classes.

📱 Responsive Design
- The UI is fully optimized for Desktop and Tablet views, ensuring that monitoring can be done from various devices without loss of functionality.
